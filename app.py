...
# Импорт модулей управления персоналом и оптимизации
from personnel_management import (
    load_employees_data, save_employees_data, detect_conflicts, merge_resources,
    render_personnel_management
)
from intelligent_optimization import (
    optimize_with_task_shifting, render_intelligent_optimization
)
...
# Функции для работы с JSON-файлом сотрудников перенесены в personnel_management.py
...
# Функции оптимизации перенесены в intelligent_optimization.py
...
def main():
    ...
    if st.session_state.workload_data is None:
        ...
        if not selected_resources and not display_data:
            ...
            render_intelligent_optimization(selected_resources)
